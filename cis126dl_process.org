...
* Terminate a Process by Name
  ...
  3. Terminate them all with =killall=.
...
** Htop - A Nicer Top
   ...
   Htop is a nicer version of =top= developed  by Hisham  Muhammad.  It is in the Universe repository.  Instsll =htop= and see how you like it.
