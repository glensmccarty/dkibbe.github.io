...
![htop screenshot](https://s3.amazonaws.com/CIS126DL/Images/htop2.png"htop")
...
Next open the graphical Screenshot utility to take a cropped screenshot of the virtual machine terminal.

<!--![Take Screenshot]()-->

## Resources

+ [The Debian Administrator's Handbook](http://debian-handbook.info/browse/stable/ "The Debian Administrator's Handbook")
+ man apt
+ man apt-cache
+ man apt-get
